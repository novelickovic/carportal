<div class="news-search mb-4">
    ...
    {!! Form::open(['method'=>'POST', 'action'=>'NewsReviewsController@searchNews'])!!}
    <div class="input-group">
        <input name="word" type="text" class="form-control form-search" placeholder="Search news">
